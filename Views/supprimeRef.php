...
<body>
    ...
    <div class="app-container">
        ...
        <div class="app-view">
          ...
          <main class="content">
            <h2>Supprimer  ce Référentiel</h2>
            <div class="ref">
              <legend></legend>
    <div class="champ">
    <?php
            ...
            <form action="../Contrôleurs/deleteRef.php" method="POST">
            <input type="hidden" name="id" value="<?php echo $referentiel['numref'];?>">

            <input type="text" placeholder="Nouveau Nom" name="nom" value="<?php echo $referentiel['Nom'];?>" readonly />

          <input type="reset" value="NON" id="annuler">
          
          <input class="buttom" type="submit" value="OUI">
          </form>
      </div>
